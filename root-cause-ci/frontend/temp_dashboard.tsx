                ...
                <div className="code-snippet-box" style={{ marginTop: '15px', borderColor: 'rgba(245, 158, 11, 0.4)' }}>
                  ...
                  {!ghResult.pr_url && (
                    <div style={{ marginTop: '15px', display: 'flex', justifyContent: 'flex-end' }}>
                      <button
                        className="btn-secondary"
                        style={{ background: '#4f46e5', color: 'white', border: 'none', padding: '8px 16px', fontWeight: 'bold' }}
                        onClick={async () => {
                          try {
                      ...
                      >
                        <span style={{display:'flex', alignItems:'center', gap:'6px'}}><Github size={16}/> Create Fix PR on GitHub</span>
                      </button>
                    </div>
                  )}
                  {ghResult.pr_url && (
                    <div style={{ marginTop: '15px', padding: '10px', background: 'rgba(16, 185, 129, 0.1)', border: '1px solid #10b981', borderRadius: '4px' }}>
                      <span style={{ color: '#10b981', fontWeight: 'bold' }}><span style={{display:'flex', alignItems:'center', gap:'6px'}}><CheckCircle size={16}/> Pull Request Created!</span> </span>
                ...
                <details style={{ marginTop: '20px' }}>
                  ...
                  <div className="code-snippet-box" style={{ marginTop: '10px' }}>
                    <div className="snippet-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      ...
                      >
                        {copied ? <span style={{display:'flex', alignItems:'center', gap:'4px'}}><CheckCircle size={14}/> Copied!</span> : <span style={{display:'flex', alignItems:'center', gap:'4px'}}><Copy size={14}/> Copy Report</span>}
                      </button>
                    </div>
                    <pre className="error-terminal">
                      {ghResult.report_preview}
